  ...
  return (
    <div className="flex items-center justify-center w-full">
      <label
        ...
        className="flex flex-col items-center justify-center w-full h-[152px] border-2 border-gray-300 px-2 text-center border-dashed rounded-lg cursor-pointer bg-white "
      >
